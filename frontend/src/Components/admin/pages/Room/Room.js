    ...
    return (
        ...
        <div className="room rom">
            ...
            <div style={{ display: "grid" }}>
                <input type="text" placeholder='join ..' onChange={(event) => { setRoomId(event.target.value) }} />
                <input type="button" value="Room .." onClick={join_Room} />
            </div>
            <div style={{ display: "grid" }}>
                <input type="text" placeholder='text' onChange={(event) => { setDataSend(event.target.value) }} />
                <input type="button" value="send ." onClick={sendMessage} />
            </div>
            <label htmlFor="" id='txtrecerve'>{dataReceive}</label>
            {/* <div className="backgroundInfo"></div>

            <div className="infoRoom"><p>Information Room</p></div>
            <CustomBtns /> */}
